...
class WalletTracker:
    ...
    def build_message(self, record: dict, last_week: dict, month_start: dict, whitelist_report: dict) -> str:
        ...
        msg += "Правда в том, что таланта и интеллекта в мире предостаточно. А вот смелости — нет. Люди, которыми вы восхищаетесь — это те, у кого хватило смелости действовать. Они не талантливее вас. Они просто предприняли действие.\n\n"
        msg += "Разрешение не даётся. Его забирают.</i>"
